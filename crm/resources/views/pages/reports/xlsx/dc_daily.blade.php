<table>
	<tr>
		<td colspan="10" style="font-weight: 500; font-size: 17px; font-family: 'Calibri Light'; text-align: left;">BRANCH DAILY SALES REPORT</td>
	</tr>
	...
	@foreach($data as $i) :
	<tr>
		<td style="text-align: left; font-size: 10px; font-family: 'Calibri';">{{ $i['dc_name'] }}</td>
