						            ...
						            <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
						                <tr>
						                    <td style="padding-top: 50px; text-align: center">
						                       <img src="{{ url('assets/images/logo.png') }}" alt="Alfanda Express" border="0" align="center" style="max-height: 80px;">
						                    </td>
						                </tr>
						            </table>
						            <!-- Email Header : END -->
											...
											<td style="padding: 0px 20px 20px; width: 35%" valign="top">
												...
												<table cellspacing="0" cellpadding="0" border="0" width="100%" valign="top">
					            					...
					            					<tr>
					            						...
					            						<td style="font-size: 12px;">{{ number_format($detail[0]->order_amount, 2) }}</td>
													</tr>
													<tr>
					            						<td style="font-size: 12px;">Change For : </td>
					            						<td style="font-size: 12px;">{{ number_format($detail[0]->change_for, 2) }}</td>
													</tr>
												...
												<table cellspacing="0" cellpadding="0" border="0" width="100%">
													...
													<tfoot>
														...
														<tr>
															...
															<td>PhP {{ number_format($data['data']['charges'], 2) }}</td>
														</tr>
														<tr>
															<td colspan="3" style="text-align: right; font-weight: 500">Amount Due :</td>
															<td style="font-weight: 500">PhP {{ number_format($data['data']['amountDue'], 2) }}</td>
														</tr>
													</tfoot>
					            				</table>
					            			</td>
