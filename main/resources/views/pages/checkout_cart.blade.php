        ...
        <div class="card" style="height: 547px;">
            ...
            <div class="card-header">
                <div class="cart-store-details">
                    <p style="font-weight: 500">Sub Total <strong class="float-right">Php {{ $result['amount'] }}</strong></p>
                    ...
                    <h6>Amount Due <strong class="float-right text-danger">Php {{ number_format($result['amount'] + Session::get('deliveryCharge'), 2) }}</strong></h6>
                </div>
            </div>
        </div>
    </div>
